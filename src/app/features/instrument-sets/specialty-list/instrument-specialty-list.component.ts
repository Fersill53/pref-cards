...
@Component({
  selector: 'app-instrument-specialty-list',
  standalone: true,
  imports: [],
  templateUrl: './instrument-specialty-list.component.html',
})
export class InstrumentSpecialtyList implements OnInit {
  ...
  goToSets(specialty: Specialty) {
    this.router.navigate(['/instrument-sets', specialty.id], {
